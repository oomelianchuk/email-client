 ...
 *
 */
public class AbsenderDaten extends JPanel {
	private JTextField email = new JTextField();
	private JTextField name = new JTextField();

	public AbsenderDaten() {
		super();
		this.setBorder(new CompoundBorder(new EmptyBorder(10, 10, 10, 10),
				new CompoundBorder(new BevelBorder(BevelBorder.LOWERED),
						new CompoundBorder(new EmptyBorder(10, 10, 10, 10), new TitledBorder("Absenderdaten")))));
		...
		this.add(emailPanel);
		JLabel emailLable = new JLabel("eMail-Adresse");
